...
window.switchTab = function(targetTab) {
    ...
    } else if (targetTab === "tab-boss") {
        if (heroLogo) {
            heroLogo.src = "imagens/ferumbras.gif";
            heroLogo.alt = "Boss Tracker";
        }
        if (heroTitle) heroTitle.innerText = "Tibia Boss Tracker & Checker";
        if (heroSubtitle) heroSubtitle.innerText = "Acompanhe as probabilidades de spawn dos bosses no servidor Ustebra e outros mundos, marque seus checks diários e exporte relatórios para seu time.";
        if (heroSection) {
